...
public class OrderController {
	...
	public String orderSessionPOST(HttpSession session,
	    ...
	    if (strCheckList != null && cartCode == null) {
	        ...
	        for (int i = 0; i < strCheckList.length; i++) {
	            ...
	            CartVO cartVO = oService.selectProductInfo(checkList[i]);
	        ...
	        CartVO cartVO = oService.selectProductInfo(Integer.parseInt(cartCode));
	        logger.debug(" cartVO :  " + cartVO);
	        cartList.add(cartVO);
	        productNum = 1;
	...
	public String orderPayPOST() throws Exception {
