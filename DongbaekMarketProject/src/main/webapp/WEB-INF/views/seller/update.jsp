  ...
  <ul>
	...
	<fieldset>
		...
		<form action="" method="post">
			아이디 : <input type="text" name="seller_id" value="${sellerVO.seller_id }" readonly="readonly"> <br>
			전화번호 : <input type="text" name="seller_phone" value="${sellerVO.seller_phone }"> <br>
			이름 : <input type="text" name="seller_name" value="${sellerVO.seller_name }"> <br>
			주소 : <input type="text" name="store_addr1" value="${sellerVO.store_addr1 }"> <br>
			상세주소 : <input type="text" name="store_addr2" value="${sellerVO.store_addr2 }"> <br>
